/* =========================================================
   CPPEM · PREPARATÓRIO ONLINE PCPE — venda direta ao checkout
   ---------------------------------------------------------
...
(function () {
  ...
  /* =========================================================
     ...
     ========================================================= */
  var CONFIG = {
    pagina:  "preparatorio-online-pcpe",
  ...
  var TONS_CACO = ["#F0DCB0", "#C9AE7A", "#8DB4D6"];
  ...
  function sairAbertura(pulou) {
    if (saiu) return;
    saiu = true;
    try { sessionStorage.setItem("pcpe-abertura", "1"); } catch (e) { /* sem storage */ }
  ...
  /* só anima número PURO em pt-BR ("1.315", "15"): "14K+" e "AO VIVO" não
  ...
  /* ─── brasas ───────────────────────────────────────────────
     ...
     nascer povoada. */
  var TONS = ["rgba(201,174,122,.9)", "rgba(175,146,86,.85)", "rgba(110,160,204,.85)"];
